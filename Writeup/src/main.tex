...
\usepackage[tableposition=top, skip=3pt]{caption}
...
%%%%%%%%%%%%%%%%%%%%%%%% Additional commands %%%%%%%%%%%%%%
\newcommand{\myhy}[2]{\href{#1}{\color{blue}\setulcolor{blue}\ul{#2}}} % Underlined and clickable links
...
\begin{titlepage}
	...
	{\normalsize 
		Writeup by Razvi\par
		\myhy{https://razvioverflow.github.io/}{RazviOverflow}
		\myhy{https://twitter.com/razvieu}{Twitter}
		\myhy{https://github.com/RazviOverflow}{Github}\par
		}
		\vspace{3cm}
	{\Huge \textbf{Integer Operations}} \\
	%\vspace{1cm}
   ...
   \begin{figure}[h]
	   \makebox[\textwidth][c]{
	   		\includegraphics[scale=0.3]{razvioverflow_logo.png}
   		}
   \end{figure}
	...
	% Set the date
	{\normalsize February the 20th 2020 \par}
	\scriptsize{Last edited on \today}
...
\input{contents/Solving_the_challenge}
